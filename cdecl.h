...
#define write_long(LONGNUM) {\
  long TMP = (long)(LONGNUM); \
  fwrite( (void *)&TMP, sizeof(long), 1, fdtmpw ); }
...
#define MAX_TABLE_LENGTH  512 // maximum number of variables in a sentence.
#define MAX_SENTENCES     200 // maximum number of sentences per function.

#define MAXINT            2147483647L // maximum integer  2**31 -1
// maximum length allowable for an identifier.
#define MAX_INT           (2<<(8*(sizeof int) -1) -1)
#define MAX_UNSIGNED_INT  (MAXINT + MAXINT +1)// maximum unsigned integer

#define MAXSTR      200
#define NULL_DEVICE "NUL" // name of the null device.
#ifndef MAXWS
//# define MAXWS      32
# define MAXWS      1024 // maximum size of a compound symbol.
#endif
...
EXTERNAL char title[FILENAME_MAX - sizeof(".   ")]; // title of the output.
